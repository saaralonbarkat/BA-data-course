...
####
##Political Science BA data course 2025-26
####
...
gapminder = read.csv("https://raw.githubusercontent.com/saaralonbarkat/BA-data-course/refs/heads/main/data/gapminder/gapminder_modern_1952_2022.csv")
